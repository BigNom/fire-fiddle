...
class App extends Component {
  ...
  handleSubmit(e) {
    alert(this.state.currentItem + ' was added');
    e.preventDefault();
        ...
        <div className='container'>
          <section className='add-item'>
            <form onSubmit={this.handleSubmit}>
              ...
              onChange={this.handleChange} defaultValue={this.state.currentItem} />
              <input type="text" name="currentPrice" 
              placeholder="What is the price?" 
              onChange={this.handleChange} defaultValue={this.state.currentPrice} />
